...
import ProductImage from "../sneaker_images/herocomponentImages/image-product-1.jpg";
import { PaystackButton } from "react-paystack";
import { v4 as uuidv4 } from "uuid";


function Checkout1() {
  const publicKey =import.meta.env.VITE_PAYSTACKAPI_KEY;
  //const publicKey = "pk_test_0d61f6f4d08c8a7e224b811f7ddc4d1b360ec853";
  
  

  //console.log(import.meta.env.VITE_PAYSTACKAPI_KEY)
